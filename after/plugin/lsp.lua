...
vim.api.nvim_create_autocmd("LspAttach", {
    ...
    callback = function(event)
        ...
        -- Show diagnostics
        map("<leader>ld", vim.diagnostic.open_float, "Show [L]ine [D]iagnostics")

        -- Type definition
        map("<leader>td", vim.lsp.buf.type_definition, "Show [T]ype [D]efinition")

        -- Call hierarchy
        map("<leader>ic", vim.lsp.buf.incoming_calls, "Show [I]ncoming [C]alls")
        map("<leader>oc", vim.lsp.buf.outgoing_calls, "Show [O]utgoing [C]alls")
